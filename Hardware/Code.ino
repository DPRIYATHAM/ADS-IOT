...
String URL = "http://192.168.159.17/your_endpoint";
String device_mac = "48:74:12:94:62:6a";
String motion_status = "Motion Detected";
...
void loop() {
  ...
  if (SerialBT.discoverAsync(btAdvertisedDeviceFound)) {
    ...
    String message_value = motion_status + "," + device_mac + ",";
